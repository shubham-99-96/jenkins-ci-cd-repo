    ...
    <div class="container-fluid">
		...
		<!--<div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">-->
                ...
                ?>
            	 <a href="employer-login" class="nav-item nav-link ms-auto btn-nav btn btn-sucess" id="btn-top">
                 <img src="img/empbag.png" class="empbag" alt="Employe Bag">  Employer Login</a>
                 <div class="nav-item dropdown">
                    <a href="<?= public_url ?>/candidate-login" class="nav-link btn btn-primary" id="btn-top"> Candidate &nbsp; Login</a>
                </div>
                <?php } ?>
